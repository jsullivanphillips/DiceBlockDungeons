...
func _build_block_resource() -> BlockResource:
	...
	resource.display_name = "%s A%d B%d D%d" % [resource.shape_id, resource.attack, resource.shield, resource.dice_cost]
	resource.price = 3 + resource.attack + resource.shield
	return resource
